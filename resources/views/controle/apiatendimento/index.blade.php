<table>
    ...
    <tbody>
    @if($apiatendimentos->count())
        @foreach($apiatendimentos as $apiatendimento)
            <tr>
                    ...
                    <td>
                    <a href="{{ route('controle.apiatendimento.update', $apiatendimento->id ) }}">Alterar</a>
                    <a href="{{ route('controle.apiatendimento.destroy', $apiatendimento->id ) }}">Excluir</a>
                </td>
        </tr>
        @endforeach
    @endif
